const preguntas = [
    {
        pregunta: "¿Como se llama el villano de la pelicula",
        respuestas: ["Safar", "Jafar", "Aladín", "Lorito"],
        correcta: 1
    },
    {
        pregunta: "¿Qué es lo que más deseaba Jasmin?",
        respuestas: ["Convertirse en Sultana", "Ser libre", 
        "Casarse con un príncipe", "Irse lejos del Reino"],
        correcta: 0
    },
    {
        pregunta: "¿Cual fue el último deseo que pidio Aladin?",
        respuestas: ["Casarse con Jasmine", 
        "Ser un príncipe", "La libertad del Genio", "Convertirse en Sultan"],
        correcta: 2
    },

    {
        pregunta: "¿Como se llaman las mascotas de la película?",
        respuestas: ["Lago - Abus - Ratag", "Abu - Tigre - Lago", "Rajah - Abu - Jafar", "Abu - Rajah - Lago"],
        correcta: 3
    },
